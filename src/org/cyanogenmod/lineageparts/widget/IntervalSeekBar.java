 ...
 */
package org.cyanogenmod.lineageparts.widget;
...
public class IntervalSeekBar extends SeekBar {
    ...
    public IntervalSeekBar(Context context, AttributeSet attrs) {
        ...
        mMax = seekBarType.getFloat(R.styleable.IntervalSeekBar_maxVal, 1.5f);
        mMin = seekBarType.getFloat(R.styleable.IntervalSeekBar_minVal, 0.5f);
